...
class CategoryPageModel extends StatefulWidget {
  final String category;

  const CategoryPageModel({super.key, required this.category});

  @override
  State<CategoryPageModel> createState() => _CategoryPageModelState();
}

class _CategoryPageModelState extends State<CategoryPageModel> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<void>(
      future: (searchQuery) {
        return seeAllPageProvider.fetchRestaurantsByCategory(
            widget.category, _textEditingController.text);
      ...
      builder: (BuildContext context, AsyncSnapshot<void> snapshot) {
        if (snapshot.hasError) {
          ...
          return Scaffold(
              appBar: AppBar(),
              body: const Center(child: CircularProgressIndicator()));
        } else if (seeAllPageProvider.categoryDocs.isEmpty) {
          return Scaffold(
            appBar: AppBar(
