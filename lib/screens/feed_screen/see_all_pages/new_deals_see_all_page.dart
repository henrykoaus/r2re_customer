...
class NewDealsSeeAllPage extends StatefulWidget {
  const NewDealsSeeAllPage({super.key});

  @override
  State<NewDealsSeeAllPage> createState() => _NewDealsSeeAllPageState();
}

class _NewDealsSeeAllPageState extends State<NewDealsSeeAllPage> {
    ...
    return FutureBuilder<void>(
      future: (searchQuery) {
        return seeAllPageProvider
            .fetchAllRestaurants(_textEditingController.text);
